				...
				<div class="row second pt-lg-4 ">
					@foreach ($photos as $photo)
						<div class="col-lg-4 col-sm-6 Thumbnail text-center mt-lg-0 my-4">
							<div class="gallery">
								<a href="{{ asset('media/events_all/workshops/3rdEdition/day1/' . $photo->getFilename()) }}" data-lightbox="mygallery">
									<img src="{{ asset('media/events_all/workshops/3rdEdition/day1/' . $photo->getFilename()) }}" alt="3rd Workshop Day1" width="350px" height="255" class="gallery-thumbnail">
								</a>
							</div>
						</div>
					@endforeach
