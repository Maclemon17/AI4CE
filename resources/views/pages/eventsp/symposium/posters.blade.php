                ...
                <div class="row ab-info second pt-lg-4 ">
                    @foreach ($posters as $poster)
                        <div class="col-lg-4 col-sm-6 Thumbnail text-center mt-lg-0 my-4">
                            <div class="gallery">
                                <a href="{{ asset('media/events_all/symposium/posters/'. $poster->getFilename()) }} " data-lightbox="mygallery">
                                    <img src="{{ asset('media/events_all/symposium/posters/'. $poster->getFilename()) }}" alt="symposium posters" height="350px" width="" class="gallery-thumbnail">
                                </a>
                            </div>
                        </div>
                    @endforeach
