    ...
    <div class="main-top" id="home">
        ...
        <div class="banner_w3lspvt-2">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">Day 1</li>
        ...
        <section class="team py-5" id="team">
            <div class="container py-xl-5 py-lg-3">
                <div class="bott-w3ls mr-xl-5">
                    <h3 class="title-w3 text-bl mb-3 font-weight-bold">Symposium on AI and CE</h3>
                </div>
