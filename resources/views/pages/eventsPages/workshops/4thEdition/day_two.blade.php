...
@section('title', '3rd Edition Workshop Day2')
        ...
        <section class="team py-2" id="team">
			<div class="container py-xl-5 py-lg-3">
				<div class="bott-w3ls mr-xl-5">
					<h3 class="title-w3 text-bl mb-3 font-weight-bold">3rd Edition Workshop Day 2</h3>
				</div>
				<div class="row second pt-lg-4 ">
					@foreach ($photos as $photo)
						<div class="col-lg-4 col-sm-6 Thumbnail text-center mt-lg-0 my-4">
							<div class="gallery">
								<a href="{{ asset('media/eventsPhotos/workshops/3rdEdition/day2/' . $photo->getFilename()) }}" data-lightbox="mygallery">
									<img src="{{ asset('media/eventsPhotos/workshops/3rdEdition/day2/' . $photo->getFilename()) }}" alt="3rd Workshop Day2" width="350px" height="255" class="gallery-thumbnail">
								</a>
							</div>
						</div>
					@endforeach
